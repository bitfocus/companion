...
class BankItemsBase extends CoreBase {
	 ...
	 * @access public
	 */
	addItemByClient(client, result, page, bank, item, answer) {
		this.addItem(page, bank, item)

		this.save();
		SendResult(client, answer, result, page, bank, this.items[page][bank] );
	 ...
	 * @access public
	 */
	deleteItemByClient(client, result, page, bank, id, answer) {
	 ...
	 * @access public
	 */
	getBankByClient(client, result, page, bank, answer) {
		SendResult(client, answer, result, page, bank, this.getBank(page, bank));
	}
