...
class BankFeedbackController extends CoreBase {
	...
	clientConnect(client) {
		...
		client.on(
			'bank_addFeedback',
			this.feedback.addItemByClient.bind(this.feedback, client, 'bank_get_feedbacks:result')
		)
		client.on(
			'bank_delFeedback',
			this.feedback.deleteItemByClient.bind(this.feedback, client, 'bank_get_feedbacks:result')
		)
		client.on(
			'bank_get_feedbacks',
			this.feedback.getBankByClient.bind(this.feedback, client, 'bank_get_feedbacks:result')
		)
	}
