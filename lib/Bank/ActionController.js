...
class BankActionController extends CoreBase {
	 ...
	 * @type {debug.Debugger}
	 */
	debug = require('debug')('lib/Bank/ActionController')
	...
	constructor(registry) {
		...
		this.definitions = {}
		this.bankStatus = {}
		this.actionsRunning = new Set()
		this.timersRunning = new Map()
	...
	clientConnect(client) {
		...
		client.on(
			'bank_action_delete',
			this.actions.deleteItemByClient.bind(this.actions, client, 'bank_actions_get:result')
		)
		...
		client.on(
			'bank_addReleaseAction',
			this.releaseActions.addItemByClient.bind(this.releaseActions, client, 'bank_release_actions_get:result')
		)
		client.on(
			'bank_release_action_delete',
			this.releaseActions.deleteItemByClient.bind(this.releaseActions, client, 'bank_release_actions_get:result')
		)
		client.on(
			'bank_release_actions_get',
			this.releaseActions.getBankByClient.bind(this.releaseActions, client, 'bank_release_actions_get:result')
		)
	}
