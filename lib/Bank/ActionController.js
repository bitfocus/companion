...
const BankActionItem = require('./ActionItem');
...
class BankActionController extends CoreBase {
	...
	constructor(registry) {
		...
		this.actions        = new BankActionItem(registry, this, 'action',         'bank_actions');
		this.releaseActions = new BankActionItem(registry, this, 'release_action', 'bank_release_actions');
