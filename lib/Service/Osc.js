...
class ServiceOsc extends ServiceBase {
	...
	constructor(registry) {
		 ...
		 * @param {?CompanionOSCArgument[]} args - arguments to include
		 */
		 ...
		 * @param {CompanionOSCBundle[]} bundle - the packages to send
		 */
 ...
 * @typedef CompanionOSCBundle
 * @property {string} address - the OSC path
 * @property {CompanionOSCArgument[]} args - arguments to include
 */
