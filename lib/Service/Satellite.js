...
exports = module.exports = function (system) {
	return new ServiceSatellite(system)
}

class ServiceSatellite {
	debug = require('debug')('lib/Service/Satellite')

	/**
	 * @param {App} system - the application's event emitter
	 */
	constructor(system) {
		this.system = system
		this.clients = []
		...
		this.buildNumber = this.system.appBuild
		...
		try {
			...
			this.debug('ERROR opening port 16622 for companion satellite devices')
		}
	}
