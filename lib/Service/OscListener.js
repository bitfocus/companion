		...
		try {
			...
			if (message.address.match(/^\/press\/bank\/\d+\/\d+$/)) {
				if (message.args.length > 0 && message.args[0].type == 'i' && message.args[0].value == '1') {
					this.logger.info('Got /press/bank/ (press) for bank', parseInt(a[3]), 'button', parseInt(a[4]))
					...
					this.logger.info('Got /press/bank/ (release) for bank', parseInt(a[3]), 'button', parseInt(a[4]))
					this.bank.action.pressBank(parseInt(a[3]), parseInt(a[4]), false)
				} else {
					this.logger.info('Got /press/bank/ (trigger)', parseInt(a[3]), 'button', parseInt(a[4]))
					this.bank.action.pressBank(parseInt(a[3]), parseInt(a[4]), true)

					setTimeout(() => {
						this.logger.info('Auto releasing /press/bank/ (trigger)', parseInt(a[3]), 'button', parseInt(a[4]))
						this.bank.action.pressBank(parseInt(a[3]), parseInt(a[4]), false)
					}, 20)
				}
				...
				if (message.args.length > 2) {
					...
					if (typeof r === 'number' && typeof g === 'number' && typeof b === 'number') {
						let col = rgb(r, g, b)
						this.logger.info('Got /style/bgcolor', parseInt(a[3]), 'button', parseInt(a[4]))
				...
				if (message.args.length > 2) {
					...
					if (typeof r === 'number' && typeof g === 'number' && typeof b === 'number') {
						let col = rgb(r, g, b)
						this.logger.info('Got /style/color', parseInt(a[3]), 'button', parseInt(a[4]))
				...
				if (message.args.length > 0) {
					...
					if (typeof text === 'string') {
						this.logger.info('Got /style/text', parseInt(a[3]), 'button', parseInt(a[4]))
