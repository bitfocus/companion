...
class ServiceElgatoPlugin extends CoreBase {
	...
	start_listening() {
		...
		this.http.on('error', (err) => {
			...
			tthis.log('error', `Couldn't bind to Elgato Plugin port ${port}`)
		})
		this.http.listen(port, () => {
			this.debug('elgato plugin ready')
			this.log('info', `Listening for Elgato Plugin commands`)
		})
	...
	stop_listening() {
		...
		this.log('info', `Stopping listening for Elgato Plugin commands`)
