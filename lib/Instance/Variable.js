...
class InstanceVariable {
	...
	constructor(system) {
		...
		this.system.emit('db_get', 'custom_variables', (val) => {
			this.custom_variables = val || {}
		})
	...
	save_custom_variables() {
		this.system.emit('db_set', 'custom_variables', this.custom_variables)
	}
