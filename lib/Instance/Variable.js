 ...
 * @typedef {{ label: string }} VariableDefinition
 */
...
class InstanceVariable extends CoreBase {
	...
	/**
	 * @type {Record<string, Record<string, VariableDefinition | undefined> | undefined>}
	 */
	#variableDefinitions = {}
	 ...
	 * @returns {{ value: boolean|number|string, variableIds: Set<string> }} result of the expression
	 */
	...
	setVariableDefinitions(instance_label, variables) {
		/** @type {Record<string, VariableDefinition>} */
		const variablesObj = {}
