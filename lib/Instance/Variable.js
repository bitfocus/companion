	...
	constructor(registry) {
		...
		this.system.on('io_connect', (client) => {
			client.on('variable_instance_definitions_get', (answer) => {
				SendResult(client, answer, 'variable_instance_definitions_get:result', null, this.variable_definitions);
			});

			client.on('variables_get', (answer) => {
				SendResult(client, answer, 'variables_get:result', null, this.getVariablesForClient());
			});
		});
