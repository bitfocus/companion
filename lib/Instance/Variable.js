...
var debug    = require('debug')('lib/Instance/Variable');
...
class Variable extends CoreBase {
	...
	constructor(registry) {
		...
		this.system.on('io_connect', (client) => {
			client.on('variable_instance_definitions_get', () => {
				client.emit('variable_instance_definitions_get:result', null, this.variable_definitions);
			});

			client.on('variables_get', () => {
				client.emit('variables_get:result', null, this.getVariablesForClient());
			});
		});
