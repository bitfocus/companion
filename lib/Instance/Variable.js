...
class InstanceVariable extends CoreBase {
	...
	forgetInstance(id, label) {
		if (label !== undefined) {
			...
			this.io.emitToRoom(VariableDefinitionsRoom, 'variable-definitions:update', label, [])
		}
	}
	...
	instanceLabelRename(labelFrom, labelTo) {
		...
		if (this.variable_definitions[labelFrom] !== undefined) {
			...
			this.io.emitToRoom(VariableDefinitionsRoom, 'variable-definitions:update', labelFrom, [])
		}
	}
	...
	setVariableDefinitions(instance_label, variables) {
		...
		this.io.emitToRoom(VariableDefinitionsRoom, 'variable-definitions:update', instance_label, variables)
	}
