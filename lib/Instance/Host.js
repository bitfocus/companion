...
const moduleBasePkgUrl = await resolve('@companion-module/base/package.json', import.meta.url)
const moduleBasePkgStr = await fs.readFile(fileURLToPath(moduleBasePkgUrl))
