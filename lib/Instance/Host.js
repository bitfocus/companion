...
const minVersion = moduleVersion.major === 0 ? `${moduleVersion.major}.${moduleVersion.minor}` : moduleVersion.major
const validApiRange = new semver.Range(`${minVersion} <= ${moduleBasePkg.version}`)
