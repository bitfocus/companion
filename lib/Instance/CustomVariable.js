 ...
 */
/** @typedef {Record<string, CustomVariableDefinition>} CustomVariableDefinitions */
...
export default class InstanceCustomVariable {
	 ...
	 * @type {CustomVariableDefinitions}
	 * @access private
	 */
	#custom_variables
	 ...
	 * @param {CustomVariableDefinitions} custom_variables
	 * @access public
	 */
	 ...
	 * @param {string} name
	 * @param {CompanionVariableValue} value
	 * @returns {string | void} Failure reason, if any
	 */
	setValue(name, value) {
		if (this.#custom_variables[name]) {
