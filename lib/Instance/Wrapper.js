...
class SocketEventsHandler {
	 ...
	 * @param {import('./Definitions.js').FeedbackInstance} feedback
	 ...
	 * @param {import('./Definitions.js').FeedbackInstance} oldFeedback
	 * @returns {Promise<void>}
	 */
	 ...
	 * @param {import('./Definitions.js').ActionInstance} action
	 * @param {string} controlId
	 * @returns {Promise<void>}
	 */
	 ...
	 * @param {import('./Definitions.js').ActionInstance} oldAction
	 * @returns {Promise<void>}
	 */
