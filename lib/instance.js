...
function instance(system) {
	...
	self.store = {
		module: [
			...
			{ label: 'Dataton Watchout Production', id: 'watchout_production' },
			{ label: 'Direct: OSC', id: 'direct_osc' },
			{ label: 'Disguise d3', id: 'disguise' },
			{ label: 'Imimot Mitti', id: 'mitti' },
			{ label: 'Millumin', id: 'millumin'},
			{ label: 'PlaybackPro Plus', id: 'playbackproplus'},
			{ label: 'Qlab', id: 'qlab' }
		],
		db: {
		}
