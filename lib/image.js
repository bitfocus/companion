...
image.prototype.boxBorder = function (x1, y1, x2, y2, color) {
	var self = this
	...
	self.pixel(x1+1,y1+1,color)
	self.pixel(x2-1,y1+1,color)
	self.pixel(x1+1,y2-1,color)
	self.pixel(x2-1,y2-1,color)
