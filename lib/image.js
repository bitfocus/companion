...
image.prototype.drawAlignedText = function (
	...
	for (var i = 0; i < displayText.length; i++) {
		...
		if (
			...
			// console.log(displayText.slice(breakPos[breakPos.length - 1], i + 1), sliceWidth, w)
...
image.prototype.drawChar = function (x, y, char, color, fontindex, double, dummy) {
	...
	// console.log('drawing', x, y, char, color, fontindex, double, dummy, gfx, maxX)
	// console.log('drawing', x, y, char, String.fromCharCode(char))
	// if (x < 0) return
