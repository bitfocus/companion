...
class GraphicsController extends CoreBase {
	constructor(registry) {
		...
		let companionFonts = FontLibrary.use({
			...
			'Companion-symbols': ['assets/Fonts/NotoSansSymbols-wght.ttf', 'assets/Fonts/NotoSansSymbols2-Regular.ttf', 'assets/Fonts/NotoSansMath-Regular.ttf', 'assets/Fonts/NotoMusic-Regular.ttf', 'assets/Fonts/NotoSansLinearA-Regular.ttf', 'assets/Fonts/NotoSansLinearB-Regular.ttf'],
		...
		//console.log('companion fonts\n', companionFonts)
		//console.log('fonts\n', this.fonts)
		//this.fonts.forEach(f => console.log(FontLibrary.family(f)))
	...
	#drawAndCacheBank(page, bank) {
		...
		setImmediate(() => {
			this.instance.variable.setVariableValues('internal', {
				[`b_text_${page}_${bank}`]: variableValue,
			})
		})
