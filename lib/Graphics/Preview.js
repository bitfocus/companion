...
class GraphicsPreview extends CoreBase {
	...
	clientConnect(client) {
		...
		const getLocationSubId = (/** @type {import('../Resources/Util.js').ControlLocation} */ location) => `${location.pageNumber}_${location.row}_${location.column}`

		client.onPromise('preview:location:subscribe',
			/**
			 * @param {import('../Resources/Util.js').ControlLocation} location 
			 * @param {string} subId 
		...
		client.onPromise('preview:location:unsubscribe',
			/**
			 * @param {import('../Resources/Util.js').ControlLocation} location 
			 * @param {string} subId 
			 * @returns {void}
		...
		client.onPromise('preview:button-reference:subscribe',
			/**
			 * @param {string} id 
			 * @param {import('../Resources/Util.js').ControlLocation} location 
		...
		client.onPromise('preview:button-reference:unsubscribe',
			/**
			* @param {string} id 
			* @returns {void}
			*/
