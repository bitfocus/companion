...
class GraphicsPreview extends CoreBase {
	...
	clientConnect(client) {
		...
		client.on('bank_preview', this.handlePreview.bind(this, client))
		client.on('bank_preview_page', this.handlePreviewPage.bind(this, client))
		client.on('web_buttons', this.handleWebButtons.bind(this, client))

		client.on('web_buttons_page', this.handleWebButtonsPage.bind(this, client))
