...
class Image {
	 ...
	 * @param {Buffer|string} bufferRaw
	 * @param {'buffer'|'base64'|undefined} type
	 */
	drawPixelBuffer(x, y, width, height, bufferRaw, type = undefined) {
		if (type === undefined && typeof bufferRaw == 'object' && bufferRaw instanceof Buffer) {
			type = 'buffer'
		} else if (type === undefined && typeof bufferRaw == 'string') {
			type = 'base64'
		}
		...
		} else if (!Buffer.isBuffer(buffer) && bufferRaw instanceof Uint8Array) {
