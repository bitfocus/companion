...
class CoreBase extends EventEmitter {
	 ...
	 * @param {import('../Registry').default} registry - the application core
	 ...
	 * @type {import('../Data/Cache').default}
	 * @access protected
	 * @readonly
	 */
	get cache() {
	 ...
	 * @type {import('../Controls/Controller').default}
	 * @access protected
	 * @readonly
	 */
	get controls() {
	 ...
	 * @type {import('../Data/Database').default}
	 * @access protected
	 * @readonly
	 */
	get db() {
	 ...
	 * @type {import('../Data/CloudDatabase').default}
	 * @access protected
	 * @readonly
	 */
	get clouddb() {
	 ...
	 * @type {import('../Graphics/Controller').default}
	 * @access protected
	 * @readonly
	 */
	get graphics() {
	 ...
	 * @type {import('../Instance/Controller').default}
	 * @access protected
	 * @readonly
	 */
	get instance() {
	 ...
	 * @type {import('../UI/Handler').default}
	 * @access protected
	 * @readonly
	 */
	get io() {
	 ...
	 * @type {import('../Page/Controller').default}
	 * @access protected
	 * @readonly
	 */
	get page() {
	...
	/**
	 * The core page controller
	 * @type {import('../Graphics/Preview').default}
	 * @access protected
	 * @readonly
	 */
	get preview() {
	 ...
	 * @type {import('../Service/Controller').default}
	 * @access protected
	 * @readonly
	 */
	get services() {
	 ...
	 * @type {import('../Surface/Controller').default}
	 * @access protected
	 * @readonly
	 */
	get surfaces() {
	 ...
	 * @type {import('../Data/UserConfig').default}
	 * @access protected
	 * @readonly
	 */
	get userconfig() {
	...
	/**
	 * The internal module
	 * @type {import('../Internal/Controller').default}
	 * @access protected
	 * @readonly
	 */
	get internalModule() {
