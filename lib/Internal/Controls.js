...
export default class Controls {
	...
	/**
	 * @param {import('../Data/Model/FeedbackModel.js').FeedbackInstance} feedback
	 * @param {string} _controlId
	 * @returns {import('../Data/Model/FeedbackModel.js').FeedbackInstance | void}
	 */
	 ...
	 * @param {import('../Data/Model/ActionModel.js').ActionInstance[]} actions
