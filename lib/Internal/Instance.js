...
export default class Instance extends CoreBase {
	constructor(registry, internalModule) {
		...
		this.instance_total = 0
		this.instance_disabled = 0
		...
		this.registry.instance.status.on('status_change', this.calculateInstanceErrors.bind(this))
	}
	...
	updateVariables() {
		this.internalModule.setVariables({
			...
			instance_disabled: this.instance_disabled,
	...
	calculateInstanceErrors(instance_statuses) {
		...
		this.instance_disabled = numDisabled
