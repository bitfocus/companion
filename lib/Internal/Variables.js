...
export default class Variables extends CoreBase {
	...
	executeFeedback(feedback) {
		if (feedback.type == 'variable_value') {
			const [instanceLabel, variableName] = SplitVariableId(feedback.options.variable)
			...
			const [instanceLabel1, variableName1] = SplitVariableId(feedback.options.variable)
			const [instanceLabel2, variableName2] = SplitVariableId(feedback.options.variable2)
