	...
	getActionDefinitions() {
		return {
			...
			custom_variable_math_operation: {
				label: 'Custom Variable: Modify Value with Math Operation',
				options: [
					{
						type: 'internal:variable',
						label: 'Variable',
			...
			custom_variable_math_int_operation: {
				label: 'Custom Variable: Modify Value with Math Convert To Int Operation',
				options: [
					{
						type: 'internal:variable',
						label: 'Variable',
			...
			custom_variable_string_trim_operation: {
				label: 'Custom Variable: Modify Value with String Trim Operation',
				options: [
					{
						type: 'internal:variable',
						label: 'Variable',
			...
			custom_variable_string_concat_operation: {
				label: 'Custom Variable: Modify Value with String Concatenation Operation',
				options: [
					{
						type: 'internal:variable',
						label: 'Variable',
			...
			custom_variable_string_substring_operation: {
				label: 'Custom Variable: Modify Value with String Substring Operation',
				options: [
					{
						type: 'internal:variable',
						label: 'Variable',
