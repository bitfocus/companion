...
export default class InternalController extends CoreBase {
	/**
	 * @type {Map<string, FeedbackInstanceExt>}
	 * @readonly
	 */
	#feedbacks = new Map()
	...
	init() {
		...
		for (const [controlId, control] of allControls.entries()) {
			...
			if (control.supportsActions && typeof control.getAllActions === 'function') {
	 ...
	 * @returns {import('../Instance/Definitions.js').ActionInstance | undefined} Updated action if any changes were made
	 */
	 ...
	 * @param {string} controlId
	 * @returns {import('../Instance/Definitions.js').FeedbackInstance | undefined} Updated feedback if any changes were made
	 */
	 ...
	 * @param {FeedbackInstanceExt} feedback
	 * @returns {any}
	 */
	 ...
	 * @param {InternalVisitor} visitor
	 * @param {import('../Instance/Definitions.js').ActionInstance[]} actions
	 * @param {import('../Instance/Definitions.js').FeedbackInstance[]} feedbacks
	 */
 ...
 * } & import('../Instance/Definitions.js').FeedbackInstance} FeedbackInstanceExt
 */

/**
 * @typedef {import('../Util/Visitors/ReferencesCollector.js').VisitorReferencesCollector | import('../Util/Visitors/ReferencesUpdater.js').VisitorReferencesUpdater} InternalVisitor
 */
 ...
 * } | {
 *   type: 'internal:variable'
 * }) & Omit<import('@companion-module/base').CompanionInputFieldBase, 'type'>} InternalInputField
 *
 * @typedef {import('@companion-module/base').SomeCompanionActionInputField | InternalInputField} InternalActionInputField
 *
 * @typedef {{
 *   label: string
 *   description?: string
