...
class InstanceStatus extends CoreBase {
	...
	getFeedbackDefinitions() {
		...
		const instanceLabels = this.instance.getAllInstanceLabels()
		for (const [id, label] of Object.entries(instanceLabels)) {
			instance_choices.push({ id, label })
		}
