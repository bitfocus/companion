...
drawbuf.prototype.drawText = function(x,y,text,color,fontindex,spacing, size) {
	...
	for (var i in chars) {
		...
		if (!(chars[i] == " " && just_wrapped == true)) {
			x_pos += (size * 2) + self.drawLetter(x+x_pos,y_pos,chars[i],color,fontindex,size);
		}
...
drawbuf.prototype.drawLetter = function(x,y,letter,color,fontindex,size) {
	var self = this;
