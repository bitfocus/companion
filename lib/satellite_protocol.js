...
protocol.SA_HEADER_PARSER = new Parser()
	.endianess("big")
	.uint16("signature")
	.uint8("command")
	.uint16("length");

protocol.SCMD_ADDDEVICE_PARSER = new Parser()
  .endianess("big")
...
protocol.SCMD_REMOVEDEVICE_PARSER = new Parser()
  .endianess("big")
  .uint16("deviceId");

protocol.SCMD_VERSION_PARSER = new Parser()
  .endianess("big")
	.uint8("versionMajor")
	.uint8("versionMinior");
...
protocol.SCMD_BUTTON_PARSER = new Parser()
  .endianess("big")
	.uint16("deviceId")
	.uint8("keyIndex")
  .uint8("state");

protocol.SCMD_BRIGHTNESS_PARSER = new Parser()
  .endianess("big")
	.uint16("deviceId")
  .uint8("percent");
...
protocol.readHeader = function(buffer) {
	...
	if (buffer.readUInt16BE(0) !== 0x5A7E) { // SATE(lite)
