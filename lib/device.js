		...
		if (!self.lockedout) {
			...
			if (state == true) {
				...
				if (bank_map[key] !== undefined) {
					console.log("presssss", self.page, bank_map[key], false, self.panel.serialnumber);
					system.emit('bank_pressed', self.page, bank_map[key], false, self.panel.serialnumber);
