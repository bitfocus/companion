...
class PageController extends CoreBase {
	...
	findAllOutOfBoundsControls() {
		...
		const minRow = this.userconfig.getKey('grid_min_row')
		const maxRow = this.userconfig.getKey('grid_max_row')
		const minColumn = this.userconfig.getKey('grid_min_column')
		const maxColumn = this.userconfig.getKey('grid_max_column')
