...
instance.prototype.action = function(action) {
	...
	if (id == 'load') {
		...
		if (self.udp !== undefined) {
			...
			console.log('load  ' + id + '  ' + avplayback[id])
		...
		if (self.udp !== undefined) {
			...
			console.log('playClip  ' + id + '  ' + avplayback[id])
			debug('sending with arguments',avplayback[id] + action.options.clip,"to",self.udp.host);
		...
		if (self.udp !== undefined) {
			...
			console.log('gotoTc  ' + id + '  ' + avplayback[id])
	...
	else if (id !== 'play' || id !=='playClip' || id !== 'gotoTc' || id !== undefined){
