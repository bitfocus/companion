...
export class VisitorReferencesUpdater {
	...
	/**
	 * @param {Record<string, string> | undefined} instanceLabelsRemap
	 * @param {Record<string, string> | undefined} instanceIdRemap
	 */
	...
	visitString(obj, propName, feedbackId) {
		...
		const labelsRemap = this.instanceLabelsRemap
