...
var debug        = require('debug')('lib/Device/Software/elgato-plugin');

class DeviceSoftwareElgatoPlugin extends Mixin(EventEmitter, DeviceBase) {
	...
	constructor(system, devicepath) {
		...
		this.keys = {};
		this.deviceType = 'StreamDeck Plugin',
