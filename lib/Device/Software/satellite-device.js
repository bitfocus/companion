...
var debug        = require('debug')('lib/Device/Software/satellite-device');
var protocol     = require('../../resources/satellite-protocol');
var Image        = require('../../image');

class DeviceSoftwareSatelliteDevice extends Mixin(EventEmitter, DeviceBase) {
	...
	constructor(system, devicepath, deviceInfo) {
		...
		this.deviceType = 'Satellite device',
...
module.exports = DeviceSoftwareSatelliteDevice;
