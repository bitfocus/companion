 ...
 * @since 1.0.4
 */
class DataDatabase extends CoreBase {
	...
	constructor(registry) {
		super(registry, 'db', 'lib/Data/Database')

		this.cfgDir = this.system.configDir
		...
		this.saveInterval = DataDatabase.SaveInterval
		...
		this.system.on('db_is_first_run', (cb) => cb(this.isFirstRun))
