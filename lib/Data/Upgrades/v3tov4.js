...
/**
 * @param {{ triggers?: import('../Model/TriggerModel.js').TriggerModel[] | Record<string, import('../Model/TriggerModel.js').TriggerModel>; }} obj
 */
function ensureTriggersAreObject(obj) {
	if (obj.triggers && Array.isArray(obj.triggers)) {
		/** @type {Record<string, import('../Model/TriggerModel.js').TriggerModel>} */
		const triggersObj = {}
