...
class DataImportExport extends CoreBase {
	...
	/**
	 * @param {Readonly<import('./Model/ExportModel.js').ExportTriggerContent4>} control
	 * @param {InstanceAppliedRemappings} instanceIdMap
	...
	/**
	 * @param {import('./Model/ExportModel.js').ExportControl4 } control
	 * @param {InstanceAppliedRemappings} instanceIdMap
 ...
 * 
 * @typedef {{
 *   object: import('./Model/ExportModel.js').ExportFull4 | import('./Model/ExportModel.js').ExportPageModel4 
 *   timeout: null
 * }} ClientPendingImport
 */
