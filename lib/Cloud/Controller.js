...
class CloudController extends CoreBase {
	...
	getBanks(clone = false) {
		...
		const retval = buttonControls.map((control) => {
			const location = this.page.getLocationOfControlId(control.controlId) || {} // TODO-coordinate
			return {
				page: location.pageNumber,
				bank: location.coordinate, // TODO-coordinate
				data: {
