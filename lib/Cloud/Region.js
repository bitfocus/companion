...
class CloudRegion {
	...
	async clientPushBank(args) {
		...
		if (args.bank && args.page) {
			this.cloud.registry?.controls?.pressControl(CreateBankControlId(parseInt(args.page), parseInt(args.bank)), true, 'cloud')
		}
		return true
	}
	...
	async clientReleaseBank(args) {
		...
		if (args.bank && args.page) {
			this.cloud.registry?.controls?.pressControl(CreateBankControlId(parseInt(args.page), parseInt(args.bank)), false, 'cloud')
		}
		return true
	}
