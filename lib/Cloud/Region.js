...
const { delay } = require('../Resources/Util')
...
class CloudRegion {
	...
	async clientPushBank(args) {
		...
		if (args.bank && args.page) {
			this.bank.action.pressBank(parseInt(args.page), parseInt(args.bank), true)
		}
		return true
	}
	...
	async clientReleaseBank(args) {
		...
		if (args.bank && args.page) {
			this.bank.action.pressBank(parseInt(args.page), parseInt(args.bank), false)
		}
		return true
	}
