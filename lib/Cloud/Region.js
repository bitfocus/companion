...
class CloudRegion {
	 ...
	 * @async
	 * @param {unknown} _args - incoming arguments
	 * @returns {Promise<Object>} the bank database
	 * @access protected
	 */
	async clientGetBanks(_args) {
	 ...
	 * @returns {Promise<boolean>} <code>true</code>
	 * @access protected
	 */
	 ...
	 * @param {SCClient.AGClientSocket} socket - the cloud connection
	 ...
	 * @access public
	 */
	async socketTransmit(channelName, data) {
		if (this.socket !== undefined) {
			try {
