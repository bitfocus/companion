	...
	self.fields = {
		'text': [
			...
			},
			{
				...
				label: 'Font size',
				default: 'large',
				choices: [ { id: '7', label: '7pt' }, { id: '14', label: '14pt' }, { id: '18', label: '18pt' }, { id: '24', label: '24pt' }, { id: '30', label: '30pt' }, { id: '44', label: '44pt' }],
				width: 2
			},
			{
		...
		'png': [
			...
			},
			{
				...
				label: 'Font size',
				default: 'large',
				choices: [ { id: 'large', label: 'Large' }, { id: 'small', label: 'Small' }],
				width: 4
			},
			{
				type: 'alignmentcontrol',
