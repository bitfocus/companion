 ...
 * @param {import('../Surface/Util').SurfaceRotation | 90 | -90 | 180 | 0 | null} rotation
 ...
 * @returns {[horizontal: string, vertical: string, full: string]}
 */
 ...
 * @returns {string}
 */
export function pad(str, ch, len) {
	str += ''
