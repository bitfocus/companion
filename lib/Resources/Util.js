import imageTools from '@julusian/image-rs'
...
export function translateRotation(rotation) {
	if (rotation === 90) return imageTools.RotationMode.CW270
	if (rotation === -90) return imageTools.RotationMode.CW90
	if (rotation === 180) return imageTools.RotationMode.CW180
	return imageTools.RotationMode.None
}
 ...
 * @returns
 * @deprecated use @julusian/image-rs instead
 */
