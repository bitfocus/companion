...
class SurfaceController extends CoreBase {
	...
	addEmulator(id, skipUpdate) {
		...
		this.#surfaceHandlers[fullId] = new SurfaceHandler(
			this.registry,
			'emulator',
	...
	addSatelliteDevice(deviceInfo) {
		...
		this.#surfaceHandlers[deviceInfo.path] = new SurfaceHandler(this.registry, 'satellite', device)
	...
	addElgatoPluginDevice(devicePath, socket) {
		...
		this.#surfaceHandlers[devicePath] = new SurfaceHandler(this.registry, 'elgato-plugin', device)
	...
	async #addDevice(deviceInfo, type, skipHidAccessCheck) {
		...
		try {
			...
			this.#surfaceHandlers[deviceInfo.path] = new SurfaceHandler(this.registry, type, dev)
