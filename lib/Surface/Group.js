...
export class SurfaceGroup extends CoreBase {
	...
	constructor(registry, groupId, soleHandler) {
		...
		if (this.groupConfig.use_last_page) {
			this.#currentPage = this.groupConfig.page ?? 1
		} else {
			this.#currentPage = this.groupConfig.page = this.groupConfig.startup_page ?? 1
		}
	...
	setGroupConfigValue(key, value) {
		// TODO
		console.log('set value', this.groupId, key, value)
	}
