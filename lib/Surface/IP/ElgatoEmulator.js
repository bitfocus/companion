...
class SurfaceIPElgatoEmulator {
	...
	clientConnect(client) {
		...
		client.on('emul_down', (keyIndex) => {
			this.system.emit('device_click', this.info.devicepath, keyIndex, true)
		})

		client.on('emul_up', (keyIndex) => {
			this.system.emit('device_click', this.info.devicepath, keyIndex, false)
		})
	}
