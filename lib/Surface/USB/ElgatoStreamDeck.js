...
const openStreamDeck = require('@elgato-stream-deck/node').openStreamDeck
const util = require('util')
const SurfaceBase = require('../Base')
const sharp = require('sharp')
const ImageWriteQueue = require('../../Resource/ImageWriteQueue')
const setTimeoutPromise = util.promisify(setTimeout)

class SurfaceUSBElgatoStreamDeck extends SurfaceBase {
	debug = require('debug')('lib/Surface/USB/ElgatoStreamDeck')
	...
	constructor(system, devicepath) {
		...
		this.streamDeck
			...
			.then((serial) => {
				...
				this.system.emit('log', `device(${this.serialnumber})`, 'debug', `Elgato ${this.streamDeck.PRODUCT_NAME} detected`)
...
exports = module.exports = SurfaceUSBElgatoStreamDeck
