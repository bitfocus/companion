		...
		if (c.style == 'text' || c.style == 'png') {
			...
			switch(c.size) {
				case 'small':
					...
					break;
				case 'large':
					img.drawAlignedText(2,18,68,52, c.text, c.color, 14, 2, 1, c.alignment.split(":",2)[0], c.alignment.split(":",2)[1]);
					break;
				case '7':
					img.drawAlignedText(2,18,68,52, c.text, c.color, 0, 2, 1, c.alignment.split(":",2)[0], c.alignment.split(":",2)[1]);
					break;
				case '14':
					img.drawAlignedText(2,18,68,52, c.text, c.color, 14, undefined, 1, c.alignment.split(":",2)[0], c.alignment.split(":",2)[1]);
					break;
				case '18':
					img.drawAlignedText(2,18,68,52, c.text, c.color, 18, undefined, 1, c.alignment.split(":",2)[0], c.alignment.split(":",2)[1]);
					break;
				case '24':
					img.drawAlignedText(2,18,68,52, c.text, c.color, 24, undefined, 1, c.alignment.split(":",2)[0], c.alignment.split(":",2)[1]);
					break;
				case '30':
					img.drawAlignedText(2,18,68,52, c.text, c.color, 30, undefined, 1, c.alignment.split(":",2)[0], c.alignment.split(":",2)[1]);
					break;
				case '44':
					img.drawAlignedText(2,18,68,52, c.text, c.color, 44, undefined, 1, c.alignment.split(":",2)[0], c.alignment.split(":",2)[1]);
					break;
				default:
					img.drawAlignedText(2,18,68,52, c.text, c.color, 0, 2, 1, c.alignment.split(":",2)[0], c.alignment.split(":",2)[1]);
					break;
