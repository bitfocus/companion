...
function graphics(_system) {
	...
	system.on('graphics_generate_preview', function (config, cb) {
...
graphics.prototype.drawBankImage = function (c, page, bank) {
	...
	} else if (!notStatic && self.pushed[page+'_'+bank] !== undefined) { // Pushed
...
graphics.prototype.getImagesForPincode = function(pincode) {
	...
	if(self.pincodebuffer[0] === undefined){
		...
		img.backgroundColor(img.rgb(15,15,15));
		img.drawAlignedText(0,0,72,72,"0",img.rgb(255,255,255),44,undefined,44,'center','center');
		self.pincodebuffer[0] = img.bufferAndTime();
		var img = new Image(72,72);
		img.backgroundColor(img.rgb(15,15,15));
		img.drawAlignedText(0,0,72,72,"1",img.rgb(255,255,255),44,undefined,44,'center','center');
		self.pincodebuffer[1] = img.bufferAndTime();
		var img = new Image(72,72);
		img.backgroundColor(img.rgb(15,15,15));
		img.drawAlignedText(0,0,72,72,"2",img.rgb(255,255,255),44,undefined,44,'center','center');
		self.pincodebuffer[2] = img.bufferAndTime();
		var img = new Image(72,72);
		img.backgroundColor(img.rgb(15,15,15));
		img.drawAlignedText(0,0,72,72,"3",img.rgb(255,255,255),44,undefined,44,'center','center');
		self.pincodebuffer[3] = img.bufferAndTime();
		var img = new Image(72,72);
		img.backgroundColor(img.rgb(15,15,15));
		img.drawAlignedText(0,0,72,72,"4",img.rgb(255,255,255),44,undefined,44,'center','center');
		self.pincodebuffer[4] = img.bufferAndTime();
		var img = new Image(72,72);
		img.backgroundColor(img.rgb(15,15,15));
		img.drawAlignedText(0,0,72,72,"5",img.rgb(255,255,255),44,undefined,44,'center','center');
		self.pincodebuffer[5] = img.bufferAndTime();
		var img = new Image(72,72);
		img.backgroundColor(img.rgb(15,15,15));
		img.drawAlignedText(0,0,72,72,"6",img.rgb(255,255,255),44,undefined,44,'center','center');
		self.pincodebuffer[6] = img.bufferAndTime();
		var img = new Image(72,72);
		img.backgroundColor(img.rgb(15,15,15));
		img.drawAlignedText(0,0,72,72,"7",img.rgb(255,255,255),44,undefined,44,'center','center');
		self.pincodebuffer[7] = img.bufferAndTime();
		var img = new Image(72,72);
		img.backgroundColor(img.rgb(15,15,15));
		img.drawAlignedText(0,0,72,72,"8",img.rgb(255,255,255),44,undefined,44,'center','center');
		self.pincodebuffer[8] = img.bufferAndTime();
		var img = new Image(72,72);
		img.backgroundColor(img.rgb(15,15,15));
		img.drawAlignedText(0,0,72,72,"9",img.rgb(255,255,255),44,undefined,44,'center','center');
		self.pincodebuffer[9] = img.bufferAndTime();
	}
	var img = new Image(72,72);
	img.backgroundColor(img.rgb(15,15,15));
