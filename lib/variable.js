...
function variable(system) {
	...
	system.on('custom_variable_set_expression', function (name, expression) {
		self.custom_variable_set_expression(name, expression)
	})

	system.on('custom_variable_store_variable', function (name, variable) {
		self.custom_variable_store_variable(name, variable)
	})

	// extract value from the stored json response data, assign to target variable
	system.on('custom_variable_set_via_jsonpath', function (name, jsonResultDataVariable, jsonPath) {
		self.custom_variable_set_via_jsonpath(name, jsonResultDataVariable, jsonPath)
	})
