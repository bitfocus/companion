			...
			socket.on('loadsave_import_page', function (topage, frompage, data) {
				...
				if (!data.instances['bitfocus-companion']) {
					data.instances['bitfocus-companion'] = {
						...
						_configIdx: 2, // This is a hack. After this version it is tracked correctly.
						// We put it to this version as its the 'safest' value to not break recent exports, at the cost of older ones (rather than the other way around)
					}
				} else {
