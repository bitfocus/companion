...
export default class FragmentActions extends CoreBase {
	...
	addRemoveRotaryActions(includeRotary) {
		if (includeRotary) {
			// ensure they exist
			this.action_sets.rotate_left = this.action_sets.rotate_left || []
			this.action_sets.rotate_right = this.action_sets.rotate_right || []
		} else {
			// remove the sets
			this.actionClearSet('rotate_left', true)
			this.actionClearSet('rotate_right', true)
			delete this.action_sets.rotate_left
			delete this.action_sets.rotate_right
		}
	}
