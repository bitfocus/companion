...
export default class ControlButtonPageNumber extends ControlBase {
	 ...
	 * @param {import('../../Shared/Model/ButtonModel.js').PageNumberButtonModel | null} storage - persisted storage object
	 ...
	 * @returns {import('../../Shared/Model/ButtonModel.js').PageNumberButtonModel}
	 * @access public
	 */
	toJSON(_clone = true) {
		return {
