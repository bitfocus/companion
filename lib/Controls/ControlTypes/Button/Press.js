...
/**
 * Class for the default button control.
 * This button supports the default press behaviour, and timed releases
 *
...
export default class ControlButtonPress extends ButtonControlBase {
	...
	optionsSetField(key, value) {
		...
		if (key === 'rotaryActions') {
			this.actions.addRemoveRotaryActions(value)
		}
