...
export default class ControlButtonPageUp extends ControlBase {
	 ...
	 * @param {import('../../Shared/Model/ButtonModel.js').PageUpButtonModel | null} storage - persisted storage object
	 ...
	 * @returns {import('../../Shared/Model/ButtonModel.js').PageUpButtonModel}
	 * @access public
	 */
	toJSON(_clone = true) {
		return {
