...
export default class ControlButtonPageUp extends ControlBase {
	 ...
	 * @param {import('../../Data/Model/ButtonModel.js').PageUpButtonModel | null} storage - persisted storage object
	 ...
	 * @returns {import('../../Data/Model/ButtonModel.js').PageUpButtonModel}
	 * @access public
	 */
	toJSON(_clone = true) {
		return {
