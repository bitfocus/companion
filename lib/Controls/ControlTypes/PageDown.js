...
export default class ControlButtonPageDown extends ControlBase {
	 ...
	 * @param {import('../../Data/Model/ButtonModel.js').PageDownButtonModel|null} storage - persisted storage object
	 ...
	 * @returns {import('../../Data/Model/ButtonModel.js').PageDownButtonModel}
	 * @access public
	 */
	toJSON(_clone = true) {
		return {
