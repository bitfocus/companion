...
/** @typedef {{ id: string, time: TimeOfDayEventParams, nextExecute: number | null }} TimeOfDayEvent */
/** @typedef {{ id: string, params: SunEventParams, nextExecute: number }} SunEvent */
...
export default class TriggersEventTimer {
	 ...
	 * @param {{ options: { seconds: number } }} event Event to describe
	 * @returns
	 */
	 ...
	 * @param {TimeOfDayEventParams} time - time details for timeofday event
	 * @returns {number | null}
	 */
	 ...
	 * @param {{ options: TimeOfDayEventParams }} event Event to describe
	 * @returns
	 */
	 ...
	 * @param {{ options: SunEventParams }} event Event to describe
	 * @returns
	 */
	 ...
	 * @param {string} id Id of the event
	 * @param {TimeOfDayEventParams} time time details
	 */
	 ...
	 * @param {string} id Id of the event
	 * @param {SunEventParams} params parameters: latitude, longitude and offset
	 */
	setSun(id, params) {
		this.clearSun(id)
