...
export default class ControlTrigger extends ControlBase {
	 ...
	 * @type {import('../../../Data/Model/TriggerModel.js').TriggerOptions}
	 * @access public
	 * @static
	 */
	 ...
	 * @param {import('../../../Data/Model/TriggerModel.js').TriggerModel | null} storage - persisted storage object
	...
	collectReferencedInstances(foundInstanceIds, foundInstanceLabels) {
		...
		this.registry.data.importExport.visitControlReferences(visitor, undefined, allActions, allFeedbacks)
	}
	 ...
	 * @returns {import('../../../Data/Model/TriggerModel.js').TriggerModel}
	 * @access public
	 */
	toJSON(clone = true) {
		/** @type {import('../../../Data/Model/TriggerModel.js').TriggerModel} */
		const obj = {
			type: this.type,
 ...
 *   description: string
 * } & import('../../../Data/Model/TriggerModel.js').TriggerOptions} ClientTriggerData
 */
