...
export default class ControlTrigger extends ControlBase {
	 ...
	 * @access public
	 */
	actionReorder(_dragStepId, dragSetId, dragIndex, _dropStepId, dropSetId, dropIndex) {
		const fromSet = this.actionsaction_sets[dragSetId]
		const toSet = this.actions.action_sets[dropSetId]
		if (fromSet && toSet) {
