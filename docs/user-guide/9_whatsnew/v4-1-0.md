---
title: Companion v4.1.0
sidebar_position: -20250916
description: Release notes for Companion 4.1.0
---
...
:::tip
Saving backups to a synced folder (Dropbox, OneDrive, or similar), automatically keeps an off-site copy — great for extra safety and easy access across machines.
:::
