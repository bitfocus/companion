---
title: Emulator
description: Browser-based Stream Deck emulator for testing setups.
---

The **Emulator** provides a simple grid of buttons in your browser. It interacts with Companion just like a physical Stream Deck and can be used to test setups or give someone a low-cost set of buttons.
...
Additional settings for each emulator are available in the [Surfaces page](../3_config/surfaces.md#surface-settings).
