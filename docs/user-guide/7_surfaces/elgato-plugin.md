---
title: Elgato Plugin
description: Setup guide for Elgato Plugin.
---
...
For this, we have a Companion plugin in [the Elgato store](https://l.companion.free/q/g80LeP8dx). You have to enable support for it in the [Settings](../3_config/settings.md#surfaces) which automatically stops Companion from attempting to use the Stream Decks directly.
