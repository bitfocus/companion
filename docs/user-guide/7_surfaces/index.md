...
Surface integration module setting are accessible from the right-hand panel of the [Surface Page](../3_config/surfaces.md). (If your browser-window only shows a single panel, click the blue <span style={{color: "white", background: "#4a9aff", borderRadius: "5px", fontSize: "0.8em", padding: "0.5em"}}>Show Settings</span> button to get to the settings panel.)
...
From there, the process to [install](../3_config/connections#adding-a-connection), [configure](../3_config/connections#configuring-a-connection), and [update](../3_config/connections#updating-a-connection), a surface module follows the same workflow as for Connections.
...
General surface settings are also accessible from the right-hand panel of the [Surface Page](../3_config/surfaces.md). (If your browser-window only shows a single panel, click the blue <span style={{color: "white", background: "#4a9aff", borderRadius: "5px", fontSize: "0.8em", padding: "0.5em"}}>Show Settings</span> button to get to the settings panel.)
