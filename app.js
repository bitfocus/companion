...
system.ready = function (logToFile) {
	...
	var server_express = require('./lib/Interface/Express')(system)
	var server_http = require('./lib/Interface/Server')(system, server_express)
	var io = require('./lib/Interface/Handler')(system, server_http)
	var log = require('./lib/Interface/Log')(system, io)
	var db = require('./lib/Database')(system, cfgDir)
	var userconfig = require('./lib/Data/UserConfig')(system)
	var server_https = require('./lib/Service/Https')(system, server_express, io)
	var update = require('./lib/Interface/Update')(system, cfgDir)
	var page = require('./lib/Page')(system)
	var appRoot = require('app-root-path')
	var variable = require('./lib/Instance/Variable')(system)
	var schedule = require('./lib/Trigger')(system)
	var feedback = require('./lib/Bank/Feedback')(system)
	var action = require('./lib/Bank/Action')(system)
	var bank = require('./lib/Bank')(system)
	var graphics = require('./lib/Graphics')(system)
	var elgatoDM = require('./lib/Surface')(system)
	var preview = require('./lib/Graphics/Preview')(system)
	var instance = require('./lib/Instance')(system)
	var osc = require('./lib/Service/Osc')(system)
	var server_api = require('./lib/Service/Api')(system)
	var server_tcp = require('./lib/Service/Tcp')(system)
	var server_udp = require('./lib/Service/Udp')(system)
	var server_emberplus = require('./lib/Service/EmberPlus')(system)
	var artnet = require('./lib/Service/Artnet')(system)
	var rosstalk = require('./lib/Service/Rosstalk')(system)
	var rest = require('./lib/Service/Rest')(system)
	var rest_poll = require('./lib/Service/RestPoll')(system)
	var loadsave = require('./lib/Data/ImportExport')(system)
	var preset = require('./lib/Instance/Preset')(system)
	var satellite = require('./lib/Service/Satellite')(system)
	var elgato_plugin_server = require('./lib/Service/ElgatoPlugin')(system)
	var help = require('./lib/Interface/Help')(system)
	var metrics = require('./lib/Data/Metrics')(system)
