...
export const ConnectionsPage = observer(function ConnectionsPage(): React.JSX.Element {
	...
	return (
		<Grid.Row className="connections-page split-panels">
			<Grid.Col
				xl={6}
				className={`connections-panel primary-panel ${showPrimaryPanel ? 'cui-d-block' : 'cui-d-xl-block cui-d-none'}`}
			>
			...
			<Grid.Col
				xl={6}
				className={`connections-panel secondary-panel ${showSecondaryPanel ? 'cui-d-block' : 'cui-d-xl-block cui-d-none'}`}
			>
