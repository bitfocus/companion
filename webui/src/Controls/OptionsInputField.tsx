...
export function InputFeatureIcons(props: InputFeatureIconsProps): JSX.Element | null {
	...
	if (props.variables)
		featureIcons.push(<FontAwesomeIcon key="variables" icon={faGlobe} title={'Supports global variables'} />)
	if (props.local) featureIcons.push(<FontAwesomeIcon key="local" icon={faDollarSign} title={'Supports local variables'} />)
