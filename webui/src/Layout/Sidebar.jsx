    ...
    <CSidebar show={show}>
      <CSidebarNav>
        ...
        <CSidebarNavItem
          ...
          href="/emulator.html"
          icon={
            <FontAwesomeIcon className="c-sidebar-nav-icon" icon={faGamepad} />
          }
          name={t("Emulator")}
        />
        <CSidebarNavItem
        ...
        <CSidebarNavItem
          ...
          icon={
            <FontAwesomeIcon className="c-sidebar-nav-icon" icon={faUsers} />
          }
          name={t("Facebook")}
        />
        <CSidebarNavItem
          ...
          icon={
            <FontAwesomeIcon className="c-sidebar-nav-icon" icon={faComments} />
          }
          name={t("Slack Chat")}
        />
        <CSidebarNavItem
        ...
        <CSidebarNavItem
          ...
          href="/help.html"
          icon={
            <FontAwesomeIcon className="c-sidebar-nav-icon" icon={faInfo} />
          }
        ...
        <CSidebarNavItem
          ...
          href="/"
          icon={
            <FontAwesomeIcon className="c-sidebar-nav-icon" icon={faFire} />
          }
