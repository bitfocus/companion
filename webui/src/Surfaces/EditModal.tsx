...
import type { AvailableDeviceInfo } from '@companion/shared/Model/Surfaces'

export interface SurfaceEditModalRef {
	show(surface: AvailableDeviceInfo): void
	ensureIdIsValid(surfaceIds: string[]): void
}
...
export const SurfaceEditModal = forwardRef<SurfaceEditModalRef, SurfaceEditModalProps>(
	function SurfaceEditModal(_props, ref) {
		...
		const [surfaceInfo, setSurfaceInfo] = useState<AvailableDeviceInfo | null>(null)
