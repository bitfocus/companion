...
export const builtinFunctionCompletions: Array<{
	...
	{ name: 'cos', detail: 'cos(number)', documentation: 'Takes an angle in radians and returns the cosine of the angle' },
	{ name: 'tan', detail: 'tan(number)', documentation: 'Takes an angle in radians and returns the tangent of the angle' },
	{ name: 'asin', detail: 'asin(number)', documentation: 'Takes a number and returns the inverse sine angle of the number in radians' },
	{ name: 'acos', detail: 'acos(number)', documentation: 'Takes a number and returns the inverse cosine angle of the number in radians' },
	{ name: 'atan', detail: 'atan(number)', documentation: 'Takes a number and returns the inverse tangent angle of the number in radians' },
