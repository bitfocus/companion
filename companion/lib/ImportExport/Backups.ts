...
export class BackupController {
	...
	clientConnect(client: ClientSocket): void {
		client.onPromise('backup-rules:run-backup-now', this.runBackupNow.bind(this))
		client.onPromise('backup-rules:delete-backup-file', this.deleteBackup.bind(this))
		client.onPromise('backup-rules:update-field', this.updateRuleField.bind(this))
		client.onPromise('backup-rules:create', this.createRule.bind(this))
		client.onPromise('backup-rules:delete', this.deleteRule.bind(this))
		client.onPromise('backup-rules:reorder', this.reorderRules.bind(this))
	}
