...
export default class ControlButtonPageNumber extends ControlBase {
	 ...
	 * @param {import('@companion/shared/Model/ButtonModel.js').PageNumberButtonModel | null} storage - persisted storage object
	 ...
	 * @returns {import('@companion/shared/Model/ButtonModel.js').PageNumberButtonModel}
	 * @access public
	 */
	toJSON(_clone = true) {
		return {
