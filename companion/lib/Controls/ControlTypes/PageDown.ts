import { PageDownButtonModel } from '@companion-app/shared/Model/ButtonModel.js'
 ...
 */
export default class ControlButtonPageDown
		...
		ControlWithoutPushed
{
	 ...
	 */
	constructor(registry: Registry, controlId: string, storage: PageDownButtonModel | null, isImport: boolean) {
