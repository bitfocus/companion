...
export default class GraphicsRenderer {
	 ...
	 * @param {import('@companion/shared/Model/StyleModel.js').DrawStyleModel['style'] | undefined} draw_style
	 * @param {import('@companion/shared/Model/StyleModel.js').DrawStyleModel} drawStyle
	 * @returns
	 */
	...
	static async drawButtonImageUnwrapped(options, drawStyle, location, pagename) {
		...
		/** @type {import('@companion/shared/Model/StyleModel.js').DrawStyleModel['style'] | undefined} */
	 ...
	 * @param {import('./Controller.js').GraphicsOptions} options
	 * @param {import('@companion/shared/Model/StyleModel.js').DrawStyleButtonModel} drawStyle The style to draw
	 * @param {import('../Resources/Util.js').ControlLocation | undefined} location
	 * @access private
	 */
