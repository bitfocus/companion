...
class PageController extends CoreBase {
	 ...
	 * @type {Record<number, import('@companion/shared/Model/PageModel.js').PageModel>}
	 * @access private
	 * @readonly
	 */
	#pages
	 ...
	 * @returns {Record<string, import('@companion/shared/Model/PageModel.js').PageModel>} the pages
	 * @access public
	 */
	getAll(clone = false) {
		if (clone) {
	 ...
	 * @param {boolean} [clone = false] - <code>true</code> if a copy should be returned
	 * @returns {import('@companion/shared/Model/PageModel.js').PageModel | undefined} the requested page
	 * @access public
	 */
	 ...
	 * Set/update a page
	 * @param {number} pageNumber - the page id
	 * @param {Omit<import('@companion/shared/Model/PageModel.js').PageModel, 'controls'>} value - the page object containing the name
	 * @param {boolean} [redraw = false] - <code>true</code> if the graphics should invalidate
	 * @access public
	 */
	 ...
	 * @param {number} pageNumber
	 * @param {import('@companion/shared/Model/PageModel.js').PageModel} newValue
