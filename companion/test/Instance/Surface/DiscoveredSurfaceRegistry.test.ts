import { DiscoveredSurfaceRegistry } from '../../../lib/Instance/Surface/DiscoveredSurfaceRegistry.js'
...
describe('DiscoveredSurfaceRegistry', () => {
	test('generates different IDs for different uniqueness keys', () => {
		...
		const id1 = generator.trackSurface('1234:5678', false, '/dev/hidraw0')
		const id2 = generator.trackSurface('1234:9999', false, '/dev/hidraw1')
	...
	test('generates different IDs for same uniqueness key with different paths', () => {
		...
		const id1 = generator.trackSurface('1234:5678', false, '/dev/hidraw0')
		const id2 = generator.trackSurface('1234:5678', false, '/dev/hidraw1')
	...
	test('returns same ID for same device path on repeated calls', () => {
		...
		const id1 = generator.trackSurface('1234:5678', false, '/dev/hidraw0')
		const id2 = generator.trackSurface('1234:5678', false, '/dev/hidraw0')
	...
	test('generates stable IDs with counter increment', () => {
		...
		const id1 = generator.trackSurface('1234:5678', false, '/dev/hidraw0')
		const id2 = generator.trackSurface('1234:5678', false, '/dev/hidraw1')
		const id3 = generator.trackSurface('1234:5678', false, '/dev/hidraw2')
	...
	test('separate instances have independent state', () => {
		...
		const id1 = generator1.trackSurface('1234:5678', false, '/dev/hidraw0')
		const id2 = generator2.trackSurface('1234:5678', false, '/dev/hidraw1')
	...
	test('handles multiple devices with same uniqueness key in batch', () => {
		...
		const ids = [
			generator.trackSurface('1234:5678', false, '/dev/hidraw0'),
			generator.trackSurface('1234:5678', false, '/dev/hidraw1'),
			generator.trackSurface('1234:5678', false, '/dev/hidraw2'),
		]
		...
		expect(generator.trackSurface('1234:5678', false, '/dev/hidraw1')).toBe(ids[1])
	})

	test('alwaysAddSuffix parameter forces suffix even for first device', () => {
		const generator = new DiscoveredSurfaceRegistry()

		const id = generator.trackSurface('1234:5678', true, '/dev/hidraw0')
	...
	test('deduplicates multiple endpoints of same device', () => {
		...
		const id1 = generator.trackSurface('1234:5678', false, '/dev/hidraw0')
		const id2 = generator.trackSurface('1234:5678', false, '/dev/hidraw0')
		const id3 = generator.trackSurface('1234:5678', false, '/dev/hidraw0')
	...
	test('handles empty uniqueness key', () => {
		...
		const id1 = generator.trackSurface('', false, '/dev/hidraw0')
		const id2 = generator.trackSurface('', false, '/dev/hidraw1')
	...
	test('real-world scenario: 2 identical Stream Decks', () => {
		...
		const deck1 = generator.trackSurface('4057:96', false, '/dev/hidraw0')
		const deck2 = generator.trackSurface('4057:96', false, '/dev/hidraw1')
		...
		expect(generator.trackSurface('4057:96', false, '/dev/hidraw0')).toBe(deck1)
		expect(generator.trackSurface('4057:96', false, '/dev/hidraw1')).toBe(deck2)
	})
	...
	test('prepareForScan removes devices not seen in current scan', () => {
		...
		const id1Again = generator.trackSurface('1234:5678', false, '/dev/hidraw0')
		const id3Again = generator.trackSurface('1234:5678', false, '/dev/hidraw2')
		...
		const id1Third = generator.trackSurface('1234:5678', false, '/dev/hidraw0')
		const id2Reconnect = generator.trackSurface('1234:5678', false, '/dev/hidraw1')
		const id3Third = generator.trackSurface('1234:5678', false, '/dev/hidraw2')
	...
	test('prepareForScan clears scan tracking sets', () => {
		...
		const id3 = generator.trackSurface('5678:1234', false, '/dev/hidraw3')
		const id4 = generator.trackSurface('5678:1234', false, '/dev/hidraw4')
	...
	test('state preserved across multiple scan cycles', () => {
		...
		// Scan 1: 3 devices
		const scan1_dev0 = generator.trackSurface('1234:5678', false, '/dev/hidraw0')
		const scan1_dev1 = generator.trackSurface('1234:5678', false, '/dev/hidraw1')
		const scan1_dev2 = generator.trackSurface('1234:5678', false, '/dev/hidraw2')

		// Scan 2: same 3 devices
		generator.prepareForScan(new Set(['/dev/hidraw0', '/dev/hidraw1', '/dev/hidraw2']))
		const scan2_dev0 = generator.trackSurface('1234:5678', false, '/dev/hidraw0')
		const scan2_dev1 = generator.trackSurface('1234:5678', false, '/dev/hidraw1')
		const scan2_dev2 = generator.trackSurface('1234:5678', false, '/dev/hidraw2')

		// Scan 3: same 3 devices
		generator.prepareForScan(new Set(['/dev/hidraw0', '/dev/hidraw1', '/dev/hidraw2']))
		const scan3_dev0 = generator.trackSurface('1234:5678', false, '/dev/hidraw0')
		const scan3_dev1 = generator.trackSurface('1234:5678', false, '/dev/hidraw1')
		const scan3_dev2 = generator.trackSurface('1234:5678', false, '/dev/hidraw2')
	...
	test('device reconnection at different path gets new serial', () => {
		...
		const id2 = generator.trackSurface('1234:5678', false, '/dev/hidraw5')
		...
		const id3 = generator.trackSurface('1234:5678', false, '/dev/hidraw6')
	...
	test('handles partial device changes between scans', () => {
		...
		// Scan 1: 4 devices
		const dev0_scan1 = generator.trackSurface('1234:5678', false, '/dev/hidraw0')
		const _dev1_scan1 = generator.trackSurface('1234:5678', false, '/dev/hidraw1')
		const _dev2_scan1 = generator.trackSurface('1234:5678', false, '/dev/hidraw2')
		const dev3_scan1 = generator.trackSurface('1234:5678', false, '/dev/hidraw3')

		// Scan 2: hidraw1 and hidraw2 removed, hidraw4 added
		generator.prepareForScan(new Set(['/dev/hidraw0', '/dev/hidraw3', '/dev/hidraw4']))
		const dev0_scan2 = generator.trackSurface('1234:5678', false, '/dev/hidraw0')
		const dev3_scan2 = generator.trackSurface('1234:5678', false, '/dev/hidraw3')
		const dev4_scan2 = generator.trackSurface('1234:5678', false, '/dev/hidraw4')
	...
	test('multiple device types tracked independently', () => {
		...
		const typeA_dev0 = generator.trackSurface('1111:2222', false, '/dev/hidraw0')
		const typeB_dev1 = generator.trackSurface('3333:4444', false, '/dev/hidraw1')
		const _typeA_dev2 = generator.trackSurface('1111:2222', false, '/dev/hidraw2')

		// Scan 2: one device of each type removed
		generator.prepareForScan(new Set(['/dev/hidraw0', '/dev/hidraw1']))
		const typeA_dev0_s2 = generator.trackSurface('1111:2222', false, '/dev/hidraw0')
		const typeB_dev1_s2 = generator.trackSurface('3333:4444', false, '/dev/hidraw1')
		...
		const typeA_dev0_s3 = generator.trackSurface('1111:2222', false, '/dev/hidraw0')
		const typeB_dev1_s3 = generator.trackSurface('3333:4444', false, '/dev/hidraw1')
		const typeA_dev3_s3 = generator.trackSurface('1111:2222', false, '/dev/hidraw3')
