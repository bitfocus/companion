...
import type { CustomVariableCollection } from './CustomVariableModel.js'
...
export type CustomVariablesModelv6 = Record<string, CustomVariableDefinitionv6>

export interface CustomVariableDefinitionv6 {
	description: string
