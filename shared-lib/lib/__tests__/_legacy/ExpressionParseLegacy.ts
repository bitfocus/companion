...
import { AssignmentPlugin, type AssignmentExpression, type UpdateExpression } from './AssignmentLegacy.js'
import { CompanionVariablesPlugin, type CompanionVariableExpression } from './CompanionVariablesLegacy.js'

// Snapshot of the original jsep-based parser, kept only for differential testing against the new
// acorn-based parser. Not used by production code.
...
export function ParseExpressionLegacy(expression: string): SomeExpressionNode {
