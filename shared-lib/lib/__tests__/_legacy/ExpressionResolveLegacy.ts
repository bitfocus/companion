...
import type { SomeExpressionNode } from './ExpressionParseLegacy.js'

// Snapshot of the original tree-walking resolver, kept only for differential testing against the new
// acorn-based resolver. Not used by production code.
...
export function ResolveExpressionLegacy(
