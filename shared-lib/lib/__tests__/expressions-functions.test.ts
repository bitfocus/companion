...
describe('functions', () => {
	...
	describe('string', () => {
		...
		it('includes', () => {
			...
			expect(ExpressionFunctions.includes(false, 'true')).toBe(false)
		...
		it('indexOf', () => {
			...
			expect(ExpressionFunctions.indexOf(false, 'true')).toBe(-1)
		...
		it('lastIndexOf', () => {
			...
			expect(ExpressionFunctions.lastIndexOf(false, 'true')).toBe(-1)
