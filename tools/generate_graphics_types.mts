...
generatedFile += `import type { ButtonGraphicsElementUsage, ButtonGraphicsDecorationType, ButtonGraphicsShowStatusIcons, HorizontalAlignment, VerticalAlignment, CompositeElementOptionKey, ColorValue } from './StyleModel.js'\n`
generatedFile += '\n'
