...
generatedFile += `import type { ButtonGraphicsElementUsage, ButtonGraphicsDecorationType, ButtonGraphicsShowStatusIcons, HorizontalAlignment, VerticalAlignment, TextStyle, CompositeElementOptionKey } from './StyleModel.js'\n`
generatedFile += '\n'
